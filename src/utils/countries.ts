...
export const countries: Country[] = [
    ...
    { name: "Åland Islands", code: "AX", dial_code: "+358", flag: "🇦🇽" },
    ...
    { name: "Antarctica", code: "AQ", dial_code: "", flag: "🇦🇶" },
    ...
    { name: "Bonaire, Sint Eustatius and Saba", code: "BQ", dial_code: "+599", flag: "🇧🇶" },
    { name: "Bosnia and Herzegovina", code: "BA", dial_code: "+387", flag: "🇧🇦" },
    { name: "Botswana", code: "BW", dial_code: "+267", flag: "🇧🇼" },
    { name: "Bouvet Island", code: "BV", dial_code: "", flag: "🇧🇻" },
    ...
    { name: "French Southern Territories", code: "TF", dial_code: "+262", flag: "🇹🇫" },
    ...
    { name: "Heard Island and McDonald Islands", code: "HM", dial_code: "", flag: "🇭🇲" },
    ...
    { name: "Saint Barthélemy", code: "BL", dial_code: "+590", flag: "🇧🇱" },
    { name: "Saint Helena, Ascension and Tristan da Cunha", code: "SH", dial_code: "+290", flag: "🇸🇭" },
    ...
    { name: "South Georgia and the South Sandwich Islands", code: "GS", dial_code: "+500", flag: "🇬🇸" },
    ...
    { name: "Svalbard and Jan Mayen", code: "SJ", dial_code: "+4779", flag: "🇸🇯" },
    ...
    { name: "United States Minor Outlying Islands", code: "UM", dial_code: "+1", flag: "🇺🇲" },
    { name: "Uruguay", code: "UY", dial_code: "+598", flag: "🇺🇾" },
    { name: "Uzbekistan", code: "UZ", dial_code: "+998", flag: "🇺🇿" },
    { name: "Vanuatu", code: "VU", dial_code: "+678", flag: "🇻🇺" },
    { name: "Venezuela (Bolivarian Republic of)", code: "VE", dial_code: "+58", flag: "🇻🇪" },
